  ...
  return (
    <div className="min-h-screen" style={{ fontFamily: '"Outfit", sans-serif', background: bg, color: '#fff' }}>
      ...
      <section className="relative pt-16 min-h-screen flex items-center overflow-hidden">
        ...
        {/* Subtle gold glow */}
        <div className="absolute top-1/3 left-0 w-[600px] h-[600px] rounded-full opacity-[0.06]"
        ...
        <div className="relative w-full max-w-6xl mx-auto px-6 py-24">
          ...
          <h1 className="animate-fade-up delay-100 text-5xl sm:text-7xl lg:text-8xl font-extrabold uppercase leading-[0.95] tracking-tight mb-6"
            ...
            The Future,
            <br />
            <span style={{ color: gold }}>Refined.</span>
          </h1>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="mb-16">
            ...
            <h2 className="text-3xl sm:text-5xl font-extrabold uppercase tracking-tight"
              ...
              Choose Your <span style={{ color: gold }}>Aether</span>
            </h2>
          </div>
              ...
              <div key={model.name}
                ...
                <div className="relative aspect-[16/10] overflow-hidden" style={{ background: '#0d0d0d' }}>
                  ...
                  <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500"
                       style={{ background: 'linear-gradient(180deg, transparent 50%, rgba(10,10,10,0.6) 100%)' }} />
                </div>
                ...
                <div className="p-6 flex-1 flex flex-col">
                  <div className="flex items-start justify-between mb-4">
                    ...
                    <div className="text-right">
                      <div className="text-xl font-bold" style={{ color: gold }}>{model.price}</div>
                    </div>
                  </div>
      ...
      <section id="experience" className="py-24 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="mb-16">
            ...
            <h2 className="text-3xl sm:text-5xl font-extrabold uppercase tracking-tight"
                style={{ fontFamily: '"Outfit", sans-serif' }}>
              The Aether <span style={{ color: gold }}>Experience</span>
            </h2>
          </div>
      ...
      <section id="about" className="py-24 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="mb-16">
            ...
            <h2 className="text-3xl sm:text-5xl font-extrabold uppercase tracking-tight"
                style={{ fontFamily: '"Outfit", sans-serif' }}>
              In Their <span style={{ color: gold }}>Words</span>
            </h2>
          </div>
          ...
          <div className="grid sm:grid-cols-3 gap-6">
            {REVIEWS.map((r) => (
              <div key={r.name} className="p-8 flex flex-col"
                   style={{ background: '#111111', border: '1px solid rgba(255,255,255,0.06)' }}>
                {/* Gold quote mark */}
                <div className="text-4xl font-serif leading-none mb-4" style={{ color: gold, opacity: 0.4 }}>&ldquo;</div>
                <p className="text-base font-light leading-relaxed mb-6 flex-1" style={{ color: 'rgba(255,255,255,0.6)' }}>
                  {r.text}
                </p>
                <div style={{ borderTop: '1px solid rgba(255,255,255,0.06)', paddingTop: '1rem' }}>
                  <div className="text-[14px] font-semibold text-white">{r.name}</div>
                  <div className="text-[13px] font-light" style={{ color: gold, opacity: 0.7 }}>{r.location}</div>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="relative max-w-xl mx-auto">
          <div className="text-center mb-14">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold uppercase leading-tight tracking-tight mb-4"
              ...
              Schedule Your
              <br />
              <span style={{ color: gold }}>Private Showing</span>
            </h2>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <select value={form.model}
                      ...
                      onFocus={(e) => e.target.style.borderColor = gold}
                      onBlur={(e) => e.target.style.borderColor = 'rgba(255,255,255,0.08)'}>
                      <option value="" style={{ background: '#111', color: '#888' }}>Select a model...</option>
                      <option value="gt" style={{ background: '#111', color: '#fff' }}>Aether GT &mdash; Grand Touring Sedan</option>
                      <option value="lx" style={{ background: '#111', color: '#fff' }}>Aether LX &mdash; Luxury Crossover</option>
                      <option value="rs" style={{ background: '#111', color: '#fff' }}>Aether RS &mdash; Performance Coupe</option>
                      <option value="unsure" style={{ background: '#111', color: '#fff' }}>Not Sure Yet</option>
                    </select>
                  </div>
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4"
          ...
          <div className="relative w-full max-w-lg max-h-[90vh] overflow-y-auto shadow-2xl"
            ...
            <div className="px-6 pt-5 pb-4 flex items-start justify-between"
              ...
              <div className="text-right">
                <div className="text-2xl font-bold" style={{ color: gold }}>{specCart.price}</div>
              </div>
            </div>
      ...
      <Link to="/"
        ...
        style={{ background: 'rgba(10,10,10,0.8)', color: 'rgba(255,255,255,0.35)', border: '1px solid rgba(255,255,255,0.06)' }}
